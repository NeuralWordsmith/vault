...
- The concept is categorized by [[Cloud - Cloud Service Models|service models]] like IaaS, PaaS, and SaaS, which define the level of user control.
- It is also defined by [[Cloud - Cloud Deployment Models|deployment models]] such as public, private, and hybrid clouds.
